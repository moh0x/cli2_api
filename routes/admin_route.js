...
router.post('/login',body("email").isEmail().isLength({min:8,max:50}).withMessage("type valid email"),body('password').isLength({min:8,max:50}).withMessage('type valid password'),adminController.login)
