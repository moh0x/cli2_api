...
const maintenanceController = require('../controller/add_maintenance')
...
router.get('/maintenances',maintenanceController.maintenanceOneUser)
router.get('/statics',maintenanceController.maintenanceStatics)
